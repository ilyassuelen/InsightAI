...
export function ReportModal({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      onClick={onClose}
      className="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 p-4 backdrop-blur-2xl"
    >
      <motion.div
        ...
        className="relative flex h-[min(900px,calc(100vh-2rem))] w-full max-w-7xl flex-col overflow-hidden rounded-[32px] border border-white/10 bg-[#0B1020]/95 shadow-[0_0_80px_rgba(59,130,246,0.12)] backdrop-blur-2xl"
      >
        {/* Background */}
        ...
        {/* Header */}
        <div className="relative z-10 flex items-center justify-between border-b border-white/10 px-7 py-6">
        ...
        {/* Content */}
        <div className="relative z-10 flex-1 overflow-y-auto px-6 py-6 lg:px-8 lg:py-8">
          <ReportViewer
            report={report}
            isLoading={isLoading}
